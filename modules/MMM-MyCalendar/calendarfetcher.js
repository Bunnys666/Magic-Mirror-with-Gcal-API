    ...
    ical.fromURL(url, opts, function (err, data) {
      ...
      var eventDate = function (event, time) {
        return event[time].length === 8
          ? moment(event[time], "YYYYMMDD")
          : moment(new Date(event[time]));
      };
      ...
      for (var e in data) {
        ...
        if (event.type === "VEVENT") {
          ...
          if (description == "undefined") {
            description = "Tidak Ada Lampiran";
          }

          var attendees = event.attendees || false;
          if (attendees == "undefined") {
            attendees = "Belum Adanya Konfirmasi";
          }

          var time = event.start || false;
          if (time == "undefined") {
            time = "Nope!";
          }
          ...
          if (typeof event.rrule != "undefined" && !isFacebookBirthday) {
            ...
            // Single event.
            var fullDayEvent = isFacebookBirthday
              ? true
