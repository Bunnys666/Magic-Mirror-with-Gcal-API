  ...
  .addBatch({
    "when parsing test1.ics (node conferences schedule from lanyrd.com, modified)": {
      ...
      "event 47f6e": {
        ...
        "starts Tue, 29 Nov 2011": function (topic) {
          assert.equal(
            topic.start.toDateString(),
            new Date(2011, 10, 29).toDateString()
          );
        }
      },
      "event 480a": {
      ...
      "event d4c8": {
        ...
        "has a start datetime": function (topic) {
          assert.equal(
            topic.start.toDateString(),
            new Date(Date.UTC(2011, 2, 12, 20, 0, 0)).toDateString()
          );
        }
      },
    ...
    "with test2.ics (testing ical features)": {
      ...
      vfreebusy: {
        ...
        "has a URL": function (topic) {
          assert.equal(
            topic.url,
            "http://www.host.com/calendar/busytime/jsmith.ifb"
          );
        }
      },
    ...
    "with test4.ics (testing tripit.com)": {
      ...
      "event c32a5...": {
        topic: function (events) {
          return _.select(_.values(events), function (x) {
            return (
              x.uid === "c32a5eaba2354bb29e012ec18da827db90550a3b@tripit.com"
            );
          })[0];
        },
        "has a start datetime": function (topic) {
    ...
    "with test5.ics (testing meetup.com)": {
      ...
      "event nsmxnyppbfc@meetup.com": {
        ...
        "has a start": function (topic) {
          ...
          assert.equal(
            topic.start.toISOString(),
            new Date(2011, 10, 09, 19, 0, 0).toISOString()
          );
        }
      }
    },
    ...
    "with test6.ics (testing assembly.org)": {
      ...
      "event with no ID": {
        ...
        "has a start": function (topic) {
          assert.equal(
            topic.start.toISOString(),
            new Date(2011, 07, 04, 12, 0, 0).toISOString()
          );
        }
      },
      "event with rrule": {
    ...
    "with test7.ics (testing dtstart of rrule)": {
      ...
      "recurring yearly event (14 july)": {
        ...
        "dt start well set": function (topic) {
          assert.equal(
            topic[0].toDateString(),
            new Date(2013, 6, 14).toDateString()
          );
        }
      }
    },
    "with test 8.ics (VTODO completion)": {
      ...
      "grabbing VTODO task": {
        ...
        "task completed": function (task) {
          ...
          assert.equal(
            task.completed.toISOString(),
            new Date(2013, 06, 16, 10, 57, 45).toISOString()
          );
        }
      }
    },
    ...
    "with test10.ics": {
      ...
      "when categories present with trailing whitespace": {
        ...
        "should contain individual category values without whitespace": function (
          e
        ) {
          assert.deepEqual(e.categories, ["cat1", "cat2", "cat3"]);
        }
    ...
    "with test11.ics (testing zimbra freebusy)": {
      ...
      "freebusy params": {
        ...
        "has a URL": function (topic) {
          assert.equal(
            topic.url,
            "http://mail.example.com/yvr-2a@example.com/20140416"
          );
        },
